...
########################## GCA_Trans config #####################################
cfg.MODEL.GCA_Trans.embed_dim = 256
cfg.MODEL.GCA_Trans.depth = 4
cfg.MODEL.GCA_Trans.num_heads = 8
cfg.MODEL.GCA_Trans.mlp_ratio = 3.
cfg.MODEL.GCA_Trans.hid_dim = 64