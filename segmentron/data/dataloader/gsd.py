...
def _get_gsd_pairs(folder, mode='train'):
    img_paths = []
    mask_paths = []
    if mode == 'train':
        ...
        img_folder = os.path.join(folder, 'test/image')
        mask_folder = os.path.join(folder, 'test/mask')
    else:
        assert  mode == "test"
        img_folder = os.path.join(folder, 'test/image')
        mask_folder = os.path.join(folder, 'test/mask')
